...
class ProdottoFactoryProviderTest {
    ...
    void creaProdottoHardwareConFactoryCorretta() {
        ...
        Prodotto prodotto = factory.creaProdotto("H001", "RAM", "Memoria RAM", "Gaming", 5, 80, 10);
    ...
    void creaProdottoSoftwareConFactoryCorretta() {
        ...
        Prodotto prodotto = factory.creaProdotto("S001", "IDE", "Ambiente di sviluppo", "Programmazione", 3, 120, 0);
